...
//		RomanNumeralator underTest = new RomanNumeralator();
//		String result1 = underTest.convertTripleDigits(111);
//		assertEquals(result1, "XI");
//		
//		String result2 = underTest.convertTripleDigits(464);
//		assertEquals(result2, "XIV");
//		
//		String result3 = underTest.convertTripleDigits(596);
//		assertEquals(result3, "XVI");
//		
//		String result4 = underTest.convertTripleDigits(909);
//		assertEquals(result3, "XVI");
//	}
}
